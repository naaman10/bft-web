...
const steps = [
  {
    name: "Enquire",
    description: "Simple and stress-free process for parents.",
    Icon: IconEnvelope,
  },
  {
  ...
  {
    name: "Start learning",
    description: "Your child begins their personalised journey.",
    Icon: IconSparkles,
  },
  {
    name: "Weekly feedback",
    description:
      "Stay up to date with progress, strengths and next steps after each week.",
    Icon: IconChatBubble,
  },
] as const;
    ...
    <section className="bg-white py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:mt-20 lg:max-w-none">
          <dl className="mx-auto grid max-w-xl grid-cols-1 gap-x-8 gap-y-12 sm:gap-y-14 text-center md:max-w-none md:grid-cols-2 lg:grid-cols-4">
            {steps.map((step) => {
              ...
              return (
                ...
                >
                  <dt className="text-base font-semibold leading-7 text-slate-900">
                    <div className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-primary-600 shadow-sm ring-1 ring-primary-600/10">
